<script lang="ts">
	/* Set único de iconos del panel: un solo grosor (2pt), esquinas redondeadas,
	   estilo SF Symbols de iOS. Nada de mezclar familias. */
	...
	const PATHS: Record<string, string> = {
		...
		crown:
			'<path d="m2 7 4.5 4L12 4l5.5 7L22 7l-1.5 11h-17Z"/><path d="M5 22h14"/>',
		phone:
		...
		card: '<rect width="22" height="16" x="1" y="4" rx="2"/><line x1="1" x2="23" y1="10" y2="10"/>',
