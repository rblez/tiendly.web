...
<div class="mx-auto max-w-2xl space-y-4 px-4 py-6">
	...
	{#if saved}<p class="rounded-btn border border-ember/20 bg-ember/10 px-3 py-3 text-xs text-ember">Tasas guardadas en esta sesión.</p>{/if}
	<button type="button" onclick={save} class="btn btn-3d btn-md w-full">Guardar tasas</button>
</div>
