<script lang="ts">
 ...
 const sections = $derived([
  { title: 'Tienda', items: [['ri-store-2-line','Información general','Nombre, usuario y descripción','informacion'],['ri-image-edit-line','Apariencia','Logo y color de la tienda','apariencia'],['ri-palette-line','Tema','Claro, oscuro o automático','tema'],['ri-list-check-2','Categorías','Organiza el catálogo de tu tienda','categorias'],['ri-eye-line','Visibilidad','Visible u oculta en Tiendly','visibilidad'],['ri-whatsapp-line','Contacto y modo de pedido','WhatsApp, Telegram y checkout','contacto'],['ri-share-line','Redes sociales','Canales oficiales de tu tienda','redes'],['ri-map-pin-line','Información adicional','Ubicación, horario y enlaces','adicional'],['ri-exchange-dollar-line','Moneda y tasas','USD o CUP y conversión base','moneda'],['ri-bank-card-line','Pagos','Métodos nativos y personalizados','pagos'],['ri-ticket-2-line','Cupones y descuentos','Códigos, límites y fechas','/dashboard/s/'+code+'/cupones']] },
  { title: 'Cuenta', items: [['ri-user-line','Perfil','Nombre personal, teléfono, avatar y resumen','cuenta'],['ri-shield-keyhole-line','Seguridad','Contraseña, correo, sesiones y eliminación','cuenta/seguridad']] },
 ]);
</script>
<svelte:head><title>Ajustes | Tiendly</title></svelte:head>
<div class="mx-auto min-h-full max-w-2xl px-4 pb-28 pt-7 sm:px-6">
 <div class="mb-8"><h1 class="text-3xl font-semibold tracking-tight text-ink">Ajustes</h1><p class="mt-2 text-sm text-muted">Configura cómo funciona tu tienda.</p></div>
