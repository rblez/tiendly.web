<script lang="ts">
 ...
 const sections = [
  { title: 'Tienda', items: [['ri-store-2-line','Información general','Nombre, usuario y descripción','informacion'],['ri-image-edit-line','Apariencia','Logo y color de tu tienda','apariencia'],['ri-list-check-2','Categorías','Organiza el catálogo de tu tienda','informacion#categorias'],['ri-eye-line','Visibilidad','Visible u oculta en Tiendly','visibilidad'],['ri-share-forward-line','Compartir tienda','URL pública, copiar y compartir','compartir'],['ri-whatsapp-line','Contacto y modo de pedido','WhatsApp y recepción de pedidos','contacto'],['ri-share-line','Redes sociales','Conecta tus perfiles','redes'],['ri-map-pin-line','Información adicional','Ubicación, horario y enlaces','adicional'],['ri-exchange-dollar-line','Moneda y tasas','CUP y USD · dos tasas editables','moneda'],['ri-bank-card-line','Pagos','Métodos de cobro','pagos'],['ri-speed-up-line','Rendimiento','Caché, almacenamiento y transferencia','rendimiento']] },
